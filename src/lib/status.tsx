...
export function batteryMeta(battery: number | null | undefined) {
  if (battery === null || battery === undefined) return { icon: Battery, label: '—', color: 'text-muted-foreground' }
...
export function signalMeta(signal: number | null | undefined) {
  if (signal === null || signal === undefined) return { icon: WifiOff, label: '—', color: 'text-muted-foreground' }
