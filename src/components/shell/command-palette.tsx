        ...
        {data && data.length > 0 && (
          <CommandGroup heading="Devices">
            {data.map((d) => (
              <CommandItem
                key={d.id}
                value={`device ${d.name} ${d.location?.name ?? ''}`}
                onSelect={() => openDev(d.id)}
              >
